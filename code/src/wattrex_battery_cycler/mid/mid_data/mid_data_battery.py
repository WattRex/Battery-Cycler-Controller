...
class MidDataBatteryC:
    ...
    def __init__(self, name: str, model : str, volt_min : int = 800,
...
class MidDataRedoxBatC(MidDataBatteryC):
    ...
    '''
    # pylint: disable=too-many-arguments
    def __init__(self, electrolyte_vol : int, name: str, model : str,
                volt_min : int = 800, volt_max : int = 1200, curr_min : int = 0,
                curr_max : int = 5000) -> None:

        self.electrolyte_vol : int = electrolyte_vol
...
class MidDataLithiumBatC(MidDataBatteryC):
    ...
    '''
    # pylint: disable=too-many-arguments
    def __init__(self, capacity : int, name: str, model : str,
                volt_min : int = 800, volt_max : int = 1200, curr_min : int = 0,
                curr_max : int = 5000) -> None:
